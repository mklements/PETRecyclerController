...
#define initialTemp 30                      //Define parameters for each edjustable setting
#define minTemp 20                      
#define maxTemp 80
#define initialSpeed 25
#define minSpeed 0
#define maxSpeed 50
#define initialMot 1
#define minMot 0
...
void updateDataDisplay ()
{
  ...
  display.setCursor(95,selected);                            //Set the display cursor position
  display.print(F(">"));
